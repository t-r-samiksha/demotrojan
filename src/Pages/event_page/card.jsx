...
// export default function TechEventFlipCard() {
...
//           <div className="tech-title">CODE MANIA &lt;/&gt;</div>
//         </div>
...
//             <p>
//               Dive deep into modern networking concepts and real-world
//               cybersecurity practices. Learn how systems communicate, defend,
//               and survive in hostile digital environments.
//             </p>

//             <ul>
//               <li> Network Fundamentals</li>
//               <li> Cyber attack types</li>
//               <li> Live security demos</li>
...
//         onClick={() => setFlipped((f) => !f)}
//         style={{
//           "--glow-main": theme.glow,
//           "--glow-soft": theme.glowSoft,
//           "--title-glow": theme.titleGlow,
//           "--gold": theme.gold,
//           "--bg-1": theme.bg1,
//           "--bg-2": theme.bg2,
//         }}
...
//           <div className="about-content">
//             <p>High-energy gaming-grade tech experience.</p>
  ...
  return (
    ...
    >
      ...
      <div className="card-face front-face">
        ...
        <div className="tech-title">{title}</div>
        <p style={{ color: '#d4b56a', marginLeft: 10 ,fontFamily:"ariel"}}>
